...
is( $oe1->user,             $config{user},     
    "Default User set from conf file" );
is( $oe1->password,         $config{password}, 
    "Default Password set from conf file" );
is( $oe1->url,              $config{url}, 
...
is( $oe1->language_terminology, $config{language_terminology},
...
is( $oe1->territory_terminology, $config{territory_terminology},
...
is( $oe1->encoding_terminology, $config{encoding_terminology},
    "Default encoding terminology set from conf file");
is( $oe1->base_path,        $config{base_path}, 
    "Base path set from conf file" );
is( $oe1->test_ehrid,        $config{test_ehrid}, 
    "Test EHRID set from conf file" );
is( $oe1->test_uid,        $config{test_uid}, 
    "Test UID set from conf file" );
...
is( $oe2->user,                     'alfred',   
    "User set from constructor params" );
is( $oe2->password,                 'teaCake5', 
    "Password set from constructor params" );
...
is( $oe2->language_terminology,     $config{language_terminology},
