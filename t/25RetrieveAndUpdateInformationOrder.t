...
for my $format ( ( 'FLAT', 'STRUCTURED', 'RAW' ) ) {
    ...
    ok( !$order_update->service_name, 'service_name not set before decompose' );
    ok( !$order_update->service_type, 'service_type not set before decompose' );
    ...
    isa_ok( $order_update->timing, 'DateTime',
        'timing set as a DateTime object' );
