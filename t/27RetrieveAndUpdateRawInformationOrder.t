...
is( $order_retrieval->response_format,
    'RAW', 'Default response is in RAW format' );
...
is( $order_update->current_state,
    'scheduled', 'current_state set after decompose' );
...
is( $order_update->start_date, $start_date,
    'start_date set after decompose' );
