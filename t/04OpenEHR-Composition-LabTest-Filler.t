...
diag('Testing OpenEHR::Composition::Elements::LabTest::Filler '
    . $OpenEHR::Composition::Elements::LabTest::Filler::VERSION);

note('Testing constuction with full parameters');
ok( my $filler1 = OpenEHR::Composition::Elements::LabTest::Filler->new(
...
ok( my $filler2 =
        OpenEHR::Composition::Elements::LabTest::Filler->new( { order_number => '17V444888', } ),
...
eval { my $filler3 = OpenEHR::Composition::Elements::LabTest::Filler->new(); };
