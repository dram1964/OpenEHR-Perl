...
diag( 'Testing OpenEHR::Composition::Elements::LabTest::Requester '
        . $OpenEHR::Composition::Elements::LabTest::Requester::VERSION );
...
ok( my $professional = OpenEHR::Composition::Elements::LabTest::Professional->new(
        {   id       => 'AB01',
            assigner => 'Carecast',
            issuer   => 'UCLH',
            type     => 'local',
...
ok( my $requester1 = OpenEHR::Composition::Elements::LabTest::Requester->new(),
...
ok( my $requester2 = OpenEHR::Composition::Elements::LabTest::Requester->new(
